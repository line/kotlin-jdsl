plugins {
    id("org.springframework.boot") version Dependencies.springBoot23Version
...
dependencies {
    ...
    implementation(platform("org.springframework.boot:spring-boot-dependencies:${Dependencies.springBoot23Version}"))
