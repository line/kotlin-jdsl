plugins {
    id("org.springframework.boot") version Dependencies.springBoot24Version
...
dependencies {
    ...
    implementation(platform("org.springframework.boot:spring-boot-dependencies:${Dependencies.springBoot24Version}"))
