package com.linecorp.kotlinjdsl.example.jpql.springjpa.delete
...
import com.linecorp.kotlinjdsl.example.jpql.springjpa.entity.department.Department
    ...
    fun `delete all books published after June 2023`() {
        ...
        val query = jpql {
            deleteFrom(
                ...
                path(Book::publishDate).greaterThan(OffsetDateTime.parse("2023-06-01T00:00:00+09:00")),
            )
        }
