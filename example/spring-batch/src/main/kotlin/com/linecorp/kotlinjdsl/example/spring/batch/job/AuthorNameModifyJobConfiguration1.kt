...
import com.linecorp.kotlinjdsl.example.spring.batch.job.AuthorNameModifyJobConfiguration1.Companion.JOB_NAME
...
class AuthorNameModifyJobConfiguration1(
    private val jobRepository: JobRepository,
    private val transactionManager: PlatformTransactionManager,
    private val entityManagerFactory: EntityManagerFactory,
    private val kotlinJdslQueryProviderFactory: KotlinJdslQueryProviderFactory,
    private val jobParameters: AuthorNameModifyJobParameters1,
) {
    companion object {
        const val JOB_NAME = "author-name-modify-job-1"
...
@Component
@ConditionalOnProperty(name = ["spring.batch.job.names"], havingValue = JOB_NAME)
data class AuthorNameModifyJobParameters1(
