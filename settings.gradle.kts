...
module(name = ":spring-data-jpa-boot4-support", path = "support/spring-data-jpa-boot4")
module(name = ":spring-batch6-support", path = "support/spring-batch6")
...
module(name = ":spring-batch6-example", path = "example/spring-batch6")
...
module(name = ":spring-data-jpa-boot4-example", path = "example/spring-data-jpa-boot4")
