...
```kotlin
dependencies {
    implementation("com.linecorp.kotlin-jdsl:jpql-dsl:3.8.0-SNAPSHOT")
    implementation("com.linecorp.kotlin-jdsl:jpql-render:3.8.0-SNAPSHOT")
}
```
...
- spring-batch-support: Spring Batch 5와 함께 쿼리를 실행하도록 도움을 주는 라이브러리.
- spring-batch6-support: Spring Batch 6와 함께 쿼리를 실행하도록 도움을 주는 라이브러리.
- spring-data-jpa-support: Spring Boot 2 또는 3과 함께 Spring Data Jpa로 쿼리를 실행하도록 도움을 주는 라이브러리.
- spring-data-jpa-boot4-support: Spring Boot 4와 함께 Spring Data Jpa로 쿼리를 실행하도록 도움을 주는 라이브러리.
