...
If you have Spring Boot and `com.linecorp.kotlinjdsl:spring-data-jpa-support` or `com.linecorp.kotlinjdsl:spring-batch-support` dependency together, the `JpqlRenderContext` bean is created by AutoConfiguration.
