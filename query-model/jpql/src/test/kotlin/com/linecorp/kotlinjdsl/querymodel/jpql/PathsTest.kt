...
//        // then
//        assertThat(actual).isEqualTo(
//            JpqlPathTreat<SuperTable1, SubTable1>(
//                JpqlPathProperty(
//                    SuperTable1::class,
//                    JpqlAliasedPath(JpqlEntity(TestTable1::class), TestTable1::class.simpleName!!),
//                    TestTable1::table1.name,
...
//            entity = JpqlAliasedPath(JpqlEntity(TestTable2::class), TestTable2::class.simpleName!!),
//            on = null,
//            joinType = JoinType.INNER,
//            fetch = false,
//        )
