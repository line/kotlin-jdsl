...
@JpqlSerializerTest
class JpqlNotEqualAnySerializerTest : WithAssertions {
    private val sut = JpqlNotEqualAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlNotEqualAny::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.notEqualAny(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlNotEqualAny<*>, writer, context)
