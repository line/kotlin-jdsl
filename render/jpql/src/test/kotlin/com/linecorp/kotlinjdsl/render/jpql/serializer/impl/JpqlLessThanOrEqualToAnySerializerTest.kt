...
@JpqlSerializerTest
class JpqlLessThanOrEqualToAnySerializerTest : WithAssertions {
    private val sut = JpqlLessThanOrEqualToAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlLessThanOrEqualToAny::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.lessThanOrEqualToAny(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlLessThanOrEqualToAny<*>, writer, context)
