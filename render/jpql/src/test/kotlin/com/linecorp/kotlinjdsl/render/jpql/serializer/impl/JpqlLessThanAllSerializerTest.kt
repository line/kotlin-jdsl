...
@JpqlSerializerTest
class JpqlLessThanAllSerializerTest : WithAssertions {
    private val sut = JpqlLessThanAllSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlLessThanAll::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.lessThanAll(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlLessThanAll<*>, writer, context)
