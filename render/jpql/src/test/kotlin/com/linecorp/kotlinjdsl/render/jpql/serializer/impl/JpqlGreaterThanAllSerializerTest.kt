...
@JpqlSerializerTest
class JpqlGreaterThanAllSerializerTest : WithAssertions {
    private val sut = JpqlGreaterThanAllSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlGreaterThanAll::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.greaterThanAll(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlGreaterThanAll<*>, writer, context)
