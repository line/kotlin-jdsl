...
@JpqlSerializerTest
class JpqlInnerAssociationFetchJoinSerializerTest : WithAssertions {
    private val sut = JpqlInnerAssociationFetchJoinSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlInnerAssociationFetchJoin::class)
    }
    ...
    fun serialize() {
        ...
        // when
        sut.serialize(part as JpqlInnerAssociationFetchJoin<*>, writer, context)
