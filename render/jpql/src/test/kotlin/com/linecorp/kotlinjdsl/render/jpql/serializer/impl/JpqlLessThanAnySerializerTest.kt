...
@JpqlSerializerTest
class JpqlLessThanAnySerializerTest : WithAssertions {
    private val sut = JpqlLessThanAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlLessThanAny::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.lessThanAny(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlLessThanAny<*>, writer, context)
