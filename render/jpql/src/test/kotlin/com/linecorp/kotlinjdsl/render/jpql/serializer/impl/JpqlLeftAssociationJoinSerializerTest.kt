...
@JpqlSerializerTest
class JpqlLeftAssociationJoinSerializerTest : WithAssertions {
    private val sut = JpqlLeftAssociationJoinSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlLeftAssociationJoin::class)
    }
    ...
    fun serialize() {
        ...
        // when
        sut.serialize(part as JpqlLeftAssociationJoin<*>, writer, context)
