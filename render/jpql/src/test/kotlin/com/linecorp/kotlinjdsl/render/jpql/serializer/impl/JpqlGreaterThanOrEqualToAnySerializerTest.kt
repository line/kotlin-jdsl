...
@JpqlSerializerTest
class JpqlGreaterThanOrEqualToAnySerializerTest : WithAssertions {
    private val sut = JpqlGreaterThanOrEqualToAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlGreaterThanOrEqualToAny::class)
    }
    ...
    fun serialize() {
        ...
        // when
        sut.serialize(part as JpqlGreaterThanOrEqualToAny<*>, writer, context)
