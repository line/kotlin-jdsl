...
@JpqlSerializerTest
class JpqlEqualAllSerializerTest : WithAssertions {
    private val sut = JpqlEqualAllSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlEqualAll::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.equalAll(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlEqualAll<*>, writer, context)
