...
@JpqlSerializerTest
class JpqlLessThanOrEqualToAllSerializerTest : WithAssertions {
    private val sut = JpqlLessThanOrEqualToAllSerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlLessThanOrEqualToAll::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.lessThanOrEqualToAll(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlLessThanOrEqualToAll<*>, writer, context)
