...
@JpqlSerializerTest
class JpqlGreaterThanAnySerializerTest : WithAssertions {
    private val sut = JpqlGreaterThanAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlGreaterThanAny::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.greaterThanAny(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlGreaterThanAny<*>, writer, context)
