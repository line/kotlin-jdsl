...
@JpqlSerializerTest
class JpqlEqualAnySerializerTest : WithAssertions {
    private val sut = JpqlEqualAnySerializer()
    ...
    fun handledType() {
        ...
        // then
        assertThat(actual).isEqualTo(JpqlEqualAny::class)
    }

    @Test
    fun serialize() {
        // given
        val part = Predicates.equalAny(
            expression1,
            subquery1,
        )
        ...
        // when
        sut.serialize(part as JpqlEqualAny<*>, writer, context)
