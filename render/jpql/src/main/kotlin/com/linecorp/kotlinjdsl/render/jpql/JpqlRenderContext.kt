...
import com.linecorp.kotlinjdsl.render.jpql.serializer.impl.JpqlModSerializer
...
import com.linecorp.kotlinjdsl.render.jpql.serializer.impl.JpqlSetOperationQuerySerializer
...
private class DefaultModule : JpqlRenderModule {
    ...
    override fun setupModule(context: JpqlRenderModule.SetupContext) {
        ...
        context.addAllSerializer(
            ...
            JpqlUpperSerializer(),
            JpqlValueSerializer(),
            JpqlSetOperationQuerySerializer(),
        )
    }
}
