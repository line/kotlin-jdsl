...
): Mutiny.Query<T> = JpqlMutinyStatelessSessionUtils.createQuery(this, query, query.returnType, context)
...
fun <T : Any> Mutiny.StatelessSession.createQuery(
    ...
    context: RenderContext,
): Mutiny.Query<T> = JpqlMutinyStatelessSessionUtils.createQuery(this, query, queryParams, query.returnType, context)
