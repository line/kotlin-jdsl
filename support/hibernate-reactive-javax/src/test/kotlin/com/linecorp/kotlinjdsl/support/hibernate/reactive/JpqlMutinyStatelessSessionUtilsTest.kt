...
class JpqlMutinyStatelessSessionUtilsTest : WithAssertions {
    ...
    fun `createQuery() with a select query`() {
        ...
        // when
        val actual = JpqlMutinyStatelessSessionUtils.createQuery(session, selectQuery1, context)
    ...
    fun `createQuery() with an update query`() {
        ...
        // when
        val actual = JpqlMutinyStatelessSessionUtils.createQuery(session, updateQuery1, context)
    ...
    fun `createQuery() with a delete query`() {
        ...
        // when
        val actual = JpqlMutinyStatelessSessionUtils.createQuery(session, deleteQuery1, context)
