...
class JpqlMutinyStatelessSessionUtilsTest : WithAssertions {
    ...
    fun `createQuery() with a query and a return type`() {
        ...
        // when
        val actual = JpqlMutinyStatelessSessionUtils.createQuery(session, query1, String::class, context)
    ...
    fun `createQuery() with a query`() {
        ...
        // when
        val actual = JpqlMutinyStatelessSessionUtils.createQuery<String>(session, query1, context)
