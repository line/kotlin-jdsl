...
class JpqlStageStatelessSessionUtilsTest : WithAssertions {
    ...
    fun `createQuery() with a select query`() {
        ...
        // when
        val actual = JpqlStageStatelessSessionUtils.createQuery(session, selectQuery1, context)
    ...
    @Test
    fun `createQuery() with a update query`() {
        // given
        val rendered1 = JpqlRendered(renderedQuery1, JpqlRenderedParams(mapOf(renderedParam1, renderedParam2)))
        ...
        // when
        val actual = JpqlStageStatelessSessionUtils.createQuery(session, updateQuery1, context)
    ...
    @Test
    fun `createQuery() with a update query and query params`() {
        // given
        val rendered1 = JpqlRendered(renderedQuery1, JpqlRenderedParams(mapOf(renderedParam1, renderedParam2)))
    ...
    fun `createQuery() with a delete query`() {
        ...
        // when
        val actual = JpqlStageStatelessSessionUtils.createQuery(session, deleteQuery1, context)
